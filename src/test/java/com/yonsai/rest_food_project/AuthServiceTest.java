...
// // 1. Given
// OAuthRequestDTO.KakaoAccount.Profile profile = new
// OAuthRequestDTO.KakaoAccount.Profile(null, "http://image.url");
// OAuthRequestDTO.KakaoAccount account = new
// OAuthRequestDTO.KakaoAccount("test@test.com", profile);
...
// // 실제로 DB에도 저장되었는지?
// assertTrue(userRepository.findByProviderAndProviderId("kakao",
// "12345").isPresent());
